...
for row in input:
	...
	output.write(str(max_direct_local_L) + '\t' + str(max_direct_local_R) + '\t' + str(max_reverse_local_L) + '\t' + str(max_reverse_local_R) + '\t')
	output.write(str(max_direct_across_L) + '\t' + str(max_direct_across_R) + '\t' + str(max_reverse_across_L) + '\t' + str(max_reverse_across_R) + '\t' + str(dist_to_integrase) + '\n')
